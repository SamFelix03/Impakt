...
**impakt** is a completely AI-powered natural disaster response and relief platform that revolutionizes how we respond to global crises. Built on **LangGraph** with Optimizations and Testing with **Opik** and powered by advanced AI agents, our platform automatically identifies the **latest disaster news** from across the internet, raises awareness on **Twitter/X**, notifies related organizations via **email**, and empowers people to make a real difference through donations and community engagement powered by a Context-Aware **Telegram Agent** assisting those who want to help.
